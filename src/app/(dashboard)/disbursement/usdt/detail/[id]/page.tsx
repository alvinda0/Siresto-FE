// app/disbursement/usdt/merchant/detail/[id]/page.tsx
"use client";
...
const DetailDisbursementMerchantUsdtPage = () => {
  usePageTitle("Disbursement Merchant USDT Details");
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600">
            View complete information about the USDT disbursement
          </p>
        </div>
      </div>
          ...
          <div className="flex items-start justify-between gap-4 flex-wrap">
            <div>
              ...
              <div className="flex items-center gap-2 mt-2">
                <p className="text-sm text-gray-500">{disbursement.disbursement_id}</p>
                <button
                  onClick={() =>
                    copyToClipboard(disbursement.disbursement_id, "Disbursement ID")
                  }
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-green-50 rounded-lg p-4 md:col-span-2">
                <p className="text-sm text-green-600 mb-1">Total Disbursement</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <p className="text-base font-medium text-gray-900">
                  {disbursement.bank_name !== "-" ? disbursement.bank_name : "USDT Wallet"}
                </p>
              </div>
              {disbursement.account_number !== "-" && (
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      onClick={() =>
                        copyToClipboard(disbursement.account_number, "Account Number")
                      }
                ...
                {disbursement.process_by && (
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        onClick={() =>
                          copyToClipboard(disbursement.process_by!, "Process By ID")
                        }
                        className="p-1 rounded hover:bg-gray-200 transition-colors shrink-0"
...
export default withRoleProtection(DetailDisbursementMerchantUsdtPage, [
  "Superuser",
  "Supervisor",
  "StaffFinance",
]);