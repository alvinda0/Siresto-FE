// app/disbursement-platform-idr/detail/[id]/page.tsx
"use client";
...
const DetailDisbursementPlatformIdrPage = () => {
  usePageTitle("Disbursement Platform IDR Details");
  const params = useParams();
  const router = useRouter();
  const disbursementId = params.id as string;

  const [disbursement, setDisbursement] = useState<DisbursementPlatform | null>(null);
  ...
  const fetchDisbursementDetails = useCallback(async () => {
    try {
      setLoading(true);
      const data = await disbursementPlatformService.getDisbursementPlatformById(
        disbursementId
      );
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600">
            View complete information about the platform disbursement
          </p>
        </div>
      </div>
      ...
      <div className="bg-white/80 backdrop-blur-xl border border-white/20 rounded-2xl shadow-lg">
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="flex items-center gap-2">
                  <p className="text-base font-medium text-gray-900 break-all">
                    {disbursement.platform_id}
                  </p>
                  <button
                    onClick={() =>
                      copyToClipboard(disbursement.platform_id, "Platform ID")
                    }
          ...
          {/* Wallet Information */}
          {(disbursement.before_wallet !== undefined || disbursement.after_wallet !== undefined) && (
            <div className="pt-6 border-t border-gray-200">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">
                Wallet Information
              </h3>
...
export default withRoleProtection(DetailDisbursementPlatformIdrPage, [
  "Superuser",
  "Supervisor",
]);