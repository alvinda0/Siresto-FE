// components/disbursement-merchant/DisbursementStatisticsCard.tsx
"use client";
...
interface DisbursementStatisticsCardProps {
  summary: DisbursementMerchantSummary[];
  total: DisbursementMerchantTotal | null;
  loading?: boolean;
}

export const DisbursementStatisticsCard: React.FC <
  DisbursementStatisticsCardProps
