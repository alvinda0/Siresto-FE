// components/disbursement-merchant/DisbursementMerchantFilterUsdt.tsx
"use client";
...
interface DisbursementMerchantFilterUsdtProps {
  onApplyFilters: (filters: DisbursementMerchantQueryParams) => void;
  onExport: () => void;
}

export const DisbursementMerchantFilterUsdt: React.FC <
  DisbursementMerchantFilterUsdtProps
