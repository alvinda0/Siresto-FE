// components/disbursement-platform/DisbursementPlatformBulkActions.tsx
"use client";
...
interface DisbursementPlatformBulkActionsProps {
  onBulkApprove?: () => void;
  onBulkReject?: () => void;
...
export const DisbursementPlatformBulkActions: React.FC <
  DisbursementPlatformBulkActionsProps
> = ({
  onBulkApprove,
  onBulkReject,
  onBulkProcessing,
