// components/disbursement-platform/ExportDisbursementPlatformModal.tsx
"use client";
...
interface ExportDisbursementPlatformModalProps {
  isOpen: boolean;
  onClose: () => void;
  type: "IDR" | "USDT";
}

export const ExportDisbursementPlatformModal: React.FC <
  ExportDisbursementPlatformModalProps
> = ({ isOpen, onClose, type }) => {
  ...
  const handleExport = async () => {
    try {
      ...
      const blob = await disbursementPlatformService.exportDisbursements(params);
      ...
      link.download = `disbursement-platform-${type.toLowerCase()}${statusText}_${timestamp}.xlsx`;
        ...
        <div className="bg-linear-to-r from-green-500 to-emerald-600 p-6 text-white">
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-xl font-bold">Export Platform Disbursement Data</h3>
                <p className="text-green-50 text-sm mt-1">
                  Export {type} platform disbursement data to Excel
                </p>
              </div>
            </div>
            <button
        ...
        <div className="p-6 space-y-5 bg-white">
          ...
          <div className="bg-blue-50 border-l-4 border-blue-500 rounded-r-lg p-4">
            <p className="text-sm text-blue-800 leading-relaxed">
              ...
              platform disbursement details based on your selected filters.
            </p>
          </div>
        </div>
