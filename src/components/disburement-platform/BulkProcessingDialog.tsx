// components/disbursement-platform/BulkProcessingDialog.tsx
"use client";
        ...
        <div className="flex items-center justify-between py-2 px-3 bg-gray-50 rounded-lg border border-gray-200">
          <div className="flex items-center gap-2">
            <Checkbox
              ...
              disabled={loading || isLoading || filteredDisbursements.length === 0}
            />
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-3 mt-1">
                    ...
                    <span className="text-xs font-semibold text-green-700">
                      Rp {disbursement.total_disbursements.toLocaleString("id-ID")}
                    </span>
                  </div>
                </div>
              </div>
