// components/settlement/SettlementMerchantDetailModal.tsx
"use client";

import React from "react";
import { Modal } from "@/components/Modal";
import { SettlementMerchant } from "@/types/settlement-merchant";

interface SettlementMerchantDetailModalProps {
  isOpen: boolean;
  onClose: () => void;
  settlement: SettlementMerchant | null;
}

export function SettlementMerchantDetailModal({
  isOpen,
  onClose,
  settlement,
}: SettlementMerchantDetailModalProps) {
