// components/settlement/BulkSettlementModal.tsx
"use client";
...
export function BulkSettlementModal({
  isOpen,
  onClose,
  onSubmit,
  isLoading,
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title="Bulk Settlement Upload" size="lg">
      <div className="space-y-6">
        ...
        <div className="flex items-start gap-3 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-blue-700 dark:text-blue-300 mt-1">
              Please upload an Excel file (.xlsx or .xls) containing settlement data.
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400">
            Enter your 6-digit security PIN to authorize this bulk settlement
          </p>
        </div>
