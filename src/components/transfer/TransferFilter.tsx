...
import { TransferQueryParams } from "@/types/transfer";
...
interface TransferFilterProps {
  onApplyFilters: (filters: TransferQueryParams) => void;
}

export const TransferFilter: React.FC<TransferFilterProps> = ({
  onApplyFilters,
}) => {
  ...
  const applyFilters = () => {
    const filters: TransferQueryParams = {
      page: 1,
      limit: 10,
    };
